...
Coloca aquí tu versión del laboratorio de datos antes de validarla con el checker del kit.

Tu entrega debe demostrar contrato de dataset, calidad, splits, leakage, features, slices y monitorización con artefactos reproducibles. Este archivo solo existe para que el ZIP descargado incluya la carpeta de trabajo del alumno; no cuenta como entrega válida.

<!-- zip-quality-audit:start -->
## Guía operativa del ZIP

Esta sección audita el ZIP como lo recibirá un alumno. Todo lo citado aquí debe estar dentro de este archivo descargable de `Entrega propia F8`, no escondido en una ruta del repositorio.
...
- Ejecuta `make run` y revisa las salidas que genere el propio ejercicio.
...
3. Guarda los outputs finales y una nota breve con la decisión técnica que tomarías en un proyecto real.
