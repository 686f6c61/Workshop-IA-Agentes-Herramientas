...
Coloca aquí tu paquete de evaluación de release antes de ejecutar:

```bash
python3 ops/check_student_submission.py --submission-dir solutions/mi-equipo --write --fail-on-missing
```

Tu carpeta debe contener el paquete de evaluación, matriz de evidencias, decisión y gate de CI. Este archivo solo existe para que el ZIP descargado incluya la carpeta de trabajo del alumno; no cuenta como entrega válida.

<!-- zip-quality-audit:start -->
## Guía operativa del ZIP

Esta sección audita el ZIP como lo recibirá un alumno. Todo lo citado aquí debe estar dentro de este archivo descargable de `Entrega propia F7`, no escondido en una ruta del repositorio.
