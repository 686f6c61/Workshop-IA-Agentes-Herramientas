...
def main():
    ...
    parser.add_argument("--contract", default="eval_contract.json")
    parser.add_argument("--rag-report", default="rag_eval_report.json")
    parser.add_argument("--evaluator-report", default="evaluator_metaeval.json")
    parser.add_argument("--calibration-manifest", default="calibration_manifest.json")
    parser.add_argument("--calibration-report", default="calibration_report.json")
    parser.add_argument("--interpretability-report", default="output/interpretability_report.json")
    parser.add_argument("--explanation-contract", default="output/explanation_contract.json")
    parser.add_argument("--explanation-gate", default="output/ci_explanation_gate.json")
    parser.add_argument("--model-card", default="output/model_card_interpretability.md")
