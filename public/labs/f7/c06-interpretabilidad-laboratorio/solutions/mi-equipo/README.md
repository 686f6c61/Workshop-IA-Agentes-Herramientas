# Entrega propia F7 C06

Coloca aquí tu revisión de interpretabilidad si quieres validar una entrega propia:

```bash
python3 ops/check_student_submission.py --submission-dir solutions/mi-equipo --write --fail-on-missing
```

Incluye decisión, contrato de explicación, gate de CI, model card y evidencias. Este archivo solo existe para que el ZIP descargado incluya la carpeta de trabajo del alumno; no cuenta como entrega válida.

<!-- zip-quality-audit:start -->
## Guía operativa del ZIP

Esta sección audita el ZIP como lo recibirá un alumno. Todo lo citado aquí debe estar dentro de este archivo descargable de `Entrega propia F7 C06`, no escondido en una ruta del repositorio.
