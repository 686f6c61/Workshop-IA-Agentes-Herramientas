...
- Controles abiertos: 2.

## Matriz resumida

| Sistema | Requisito | Estado | Identidad | Credencial | Tools | Memoria | Prueba de ingeniería |
|---|---|---|---|---|---|---|---|
| `admissions_prioritization_helper` | `agent_identity_and_short_lived_credentials` | `pass` | agent_id único por sistema y entorno | token corto con scopes de lectura y preparación | sin tools de escritura directa | sin memoria compartida entre sesiones | revisar TTL, rotación, owner y traza de uso de credencial |
