...
| `admissions_prioritization_helper` | `compliance` | `recordkeeping_export` | `pass` | `evidence/recordkeeping_contract.json` | `true` | archivo presente; verificar que el contrato está conectado a export real de trazas |
...
| `admissions_prioritization_helper` | `zero_trust_agents` | `agent_identity_and_short_lived_credentials` | `pass` | `evidence/agent_identity_policy.yaml` | `true` | evidencia presente; revisar calidad y vigencia |
