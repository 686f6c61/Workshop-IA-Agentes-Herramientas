# Entrega del kit: F9 · Laboratorio de gobernanza

## 0. Archivos del ZIP que he usado

- Entradas: `data/governance_findings.csv`, `data/governance_findings_mi_equipo.csv`, `data/governance_findings_remediated.csv` y `data/governance_findings_student.csv`.
- Contratos o políticas: `contracts/final_governance_policy.json`.
- Código ejecutado: `ops/check_student_submission.py` y `ops/run_governance_lab.py`.
- Evidencias generadas: `output/agent_boundary_review.md`, `output/evidence_package_index.md`, `output/executive_brief.md`, `output/governance_release_decision.md`, `output/mi_equipo/agent_boundary_review.md` y `output/mi_equipo/evidence_package_index.md`.
