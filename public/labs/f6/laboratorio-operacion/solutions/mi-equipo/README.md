...
Tu carpeta debe contener evidencias de readiness, continuidad, postmortem, regresión y decisión operativa. Este archivo solo existe para que el ZIP descargado incluya la carpeta de trabajo del alumno; no cuenta como entrega válida.

<!-- zip-quality-audit:start -->
## Guía operativa del ZIP

Esta sección audita el ZIP como lo recibirá un alumno. Todo lo citado aquí debe estar dentro de este archivo descargable de `Entrega propia F6`, no escondido en una ruta del repositorio.
