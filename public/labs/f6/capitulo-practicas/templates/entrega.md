# Entrega del kit: Kit F6: prácticas por capítulo

## 0. Archivos del ZIP que he usado

- Entradas: `data/handoff_examples.jsonl` y `data/incident_events.jsonl`.
- Contratos o políticas: `ops/ai/routing_policy.yaml`.
- Código ejecutado: `ops/ai/evalops_release_gate.py`, `ops/ai/handoff_queue.py`, `ops/ai/incident_review.py` y `ops/ai/observability_contract.py`.
- Evidencias generadas: `output/c01_decision.md`, `output/c02_decision.md`, `output/c03_decision.md`, `output/c04_decision.md`, `output/c05_decision.md` y `output/c06_decision.md`.
