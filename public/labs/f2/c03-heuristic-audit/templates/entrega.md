# Entrega del kit: Kit F2 C03: auditar heurísticas

## 0. Archivos del ZIP que he usado

- Entradas: `data/heuristic_graph.json`.
- Contratos o políticas: `contracts/heuristic_policy.json`.
- Código ejecutado: `ops/audit_heuristics.py`.
- Evidencias generadas: `output/heuristic_decision.md` y `output/heuristic_report.json`.
