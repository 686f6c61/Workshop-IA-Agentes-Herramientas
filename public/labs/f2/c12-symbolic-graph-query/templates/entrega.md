# Entrega del kit: Kit F2 C12: micrografo simbólico con inferencia

## 0. Archivos del ZIP que he usado

- Entradas: `data/triples.json`.
- Contratos o políticas: `contracts/graph_policy.json`.
- Código ejecutado: `ops/query_symbolic_graph.py`.
- Evidencias generadas: `output/symbolic_graph_decision.md` y `output/symbolic_graph_report.json`.
