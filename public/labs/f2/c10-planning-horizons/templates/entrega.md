# Entrega del kit: Kit F2 C10: heurística, horizonte y replanificación

## 0. Archivos del ZIP que he usado

- Entradas: `data/planning_horizon_case.json`.
- Contratos o políticas: `contracts/planning_horizon_policy.json`.
- Código ejecutado: `ops/compare_planning_strategies.py`.
- Evidencias generadas: `output/planning_horizon_decision.md` y `output/planning_horizon_report.json`.
