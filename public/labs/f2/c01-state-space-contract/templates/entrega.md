# Entrega del kit: Kit F2 C01: contrato de un problema de búsqueda

## 0. Archivos del ZIP que he usado

- Entradas: `data/search_problem.json`.
- Contratos o políticas: `contracts/search_policy.json`.
- Código ejecutado: `ops/audit_search_problem.py`.
- Evidencias generadas: `output/search_model_decision.md` y `output/search_model_report.json`.
