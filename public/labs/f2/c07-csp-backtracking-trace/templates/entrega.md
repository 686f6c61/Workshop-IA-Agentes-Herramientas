# Entrega del kit: Kit F2 C07: traza de backtracking CSP

## 0. Archivos del ZIP que he usado

- Entradas: `data/backtracking_problem.json`.
- Contratos o políticas: `contracts/backtracking_policy.json`.
- Código ejecutado: `ops/trace_backtracking.py`.
- Evidencias generadas: `output/backtracking_decision.md`, `output/backtracking_report.json` y `output/backtracking_trace.jsonl`.
