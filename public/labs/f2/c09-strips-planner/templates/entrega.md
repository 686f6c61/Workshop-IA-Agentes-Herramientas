# Entrega del kit: Kit F2 C09: planificador STRIPS mínimo

## 0. Archivos del ZIP que he usado

- Entradas: `data/planning_problem.json`.
- Contratos o políticas: `contracts/planning_policy.json`.
- Código ejecutado: `ops/solve_strips_plan.py`.
- Evidencias generadas: `output/strips_plan_decision.md` y `output/strips_plan_report.json`.
