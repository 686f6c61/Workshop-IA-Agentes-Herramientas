# Entrega del kit: Kit F2 C11: minimax, alfa-beta y UCT en decisiones con otro actor

## 0. Archivos del ZIP que he usado

- Entradas: `data/game_tree.json`.
- Contratos o políticas: `contracts/game_policy.json`.
- Código ejecutado: `ops/audit_game_search.py`.
- Evidencias generadas: `output/game_search_decision.md` y `output/game_search_report.json`.
