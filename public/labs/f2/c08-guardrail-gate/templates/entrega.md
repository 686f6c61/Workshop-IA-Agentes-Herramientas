# Entrega del kit: Kit F2 C08: guardrail gate para tools

## 0. Archivos del ZIP que he usado

- Entradas: `data/refund_calls.json`.
- Contratos o políticas: `contracts/guardrail_policy.json`.
- Código ejecutado: `ops/evaluate_guardrails.py`.
- Evidencias generadas: `output/guardrail_decision.md`, `output/guardrail_report.json` y `output/guardrail_audit_log.jsonl`.
