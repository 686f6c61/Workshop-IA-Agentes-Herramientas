# Entrega del kit: Kit F2 C04: política de acciones para un agente

## 0. Archivos del ZIP que he usado

- Entradas: `data/agent_case.json`.
- Contratos o políticas: `contracts/action_policy.json`.
- Código ejecutado: `ops/rank_agent_actions.py`.
- Evidencias generadas: `output/agent_action_decision.md` y `output/agent_action_report.json`.
