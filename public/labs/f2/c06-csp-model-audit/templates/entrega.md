# Entrega del kit: Kit F2 C06: auditoría de modelo CSP

## 0. Archivos del ZIP que he usado

- Entradas: `data/course_schedule_model.json`.
- Contratos o políticas: `contracts/csp_model_policy.json`.
- Código ejecutado: `ops/audit_csp_model.py`.
- Evidencias generadas: `output/csp_model_decision.md` y `output/csp_model_report.json`.
