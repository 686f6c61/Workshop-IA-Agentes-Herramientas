# Entrega del kit: Kit F2 C02: comparar políticas de frontera

## 0. Archivos del ZIP que he usado

- Entradas: `data/weighted_graph.json`.
- Contratos o políticas: `contracts/frontier_policy.json`.
- Código ejecutado: `ops/compare_frontiers.py`.
- Evidencias generadas: `output/frontier_decision.md` y `output/frontier_report.json`.
