# Entrega del kit: F4 · Prácticas ejecutables por capítulo

## 0. Archivos del ZIP que he usado

- Entradas: `data/practice_cases.json`.
- Contratos o políticas: `contracts/practice_policy.json`.
- Código ejecutado: `ops/run_f4_practices.py`.
