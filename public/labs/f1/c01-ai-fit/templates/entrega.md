# Entrega del kit: Kit F1 C01: decidir si necesitas IA generativa

## 0. Archivos del ZIP que he usado

- Entradas: `data/use_cases.json`.
- Contratos o políticas: `contracts/decision_policy.json`.
- Código ejecutado: `ops/triage_ai_fit.py`.
- Evidencias generadas: `output/ai_fit_decision.md` y `output/ai_fit_report.json`.
