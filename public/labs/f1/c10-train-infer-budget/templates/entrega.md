# Entrega del kit: Kit F1 C10: presupuesto de entrenamiento e inferencia

## 0. Archivos del ZIP que he usado

- Entradas: `data/model_scenarios.json`.
- Contratos o políticas: `contracts/deployment_policy.json`.
- Código ejecutado: `ops/plan_train_infer.py`.
- Evidencias generadas: `output/train_infer_decision.md` y `output/train_infer_report.json`.
