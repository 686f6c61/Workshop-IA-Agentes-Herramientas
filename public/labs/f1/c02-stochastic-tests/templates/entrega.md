# Entrega del kit: Kit F1 C02: tests para salidas probabilísticas

## 0. Archivos del ZIP que he usado

- Entradas: `data/sampling_cases.json`.
- Contratos o políticas: `contracts/eval_policy.json`.
- Código ejecutado: `ops/run_stochastic_eval.py`.
- Evidencias generadas: `output/stochastic_eval_decision.md` y `output/stochastic_eval_report.json`.
