# Entrega del kit: F1 · Laboratorio de fundamentos

## 0. Archivos del ZIP que he usado

- Entradas: `data/classifier_cases.json` y `data/semantic_documents.json`.
- Contratos o políticas: `contracts/fundamentos_lab_contract.json`.
- Código ejecutado: `ops/check_student_submission.py`, `ops/evaluate_classifier.py` y `ops/run_semantic_search.py`.
- Evidencias generadas: `output/classifier_decision.md`, `output/semantic_search_decision.md`, `output/student_submission_report.md`, `output/classifier_metrics.json`, `output/semantic_search_report.json` y `output/semantic_search_traces.jsonl`.
