# Entrega del kit: Kit F1 C09: inspeccionar tokens y embeddings sin API

## 0. Archivos del ZIP que he usado

- Entradas: `data/text_cases.json`.
- Contratos o políticas: `contracts/token_embedding_policy.json`.
- Código ejecutado: `ops/inspect_tokens_embeddings.py`.
- Evidencias generadas: `output/token_embedding_decision.md` y `output/token_embedding_report.json`.
