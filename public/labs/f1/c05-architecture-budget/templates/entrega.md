# Entrega del kit: Kit F1 C05: presupuesto y contrato de una red neuronal

## 0. Archivos del ZIP que he usado

- Entradas: `data/architecture_candidates.json`.
- Contratos o políticas: `contracts/architecture_policy.json`.
- Código ejecutado: `ops/audit_architectures.py`.
- Evidencias generadas: `output/architecture_decision.md` y `output/architecture_report.json`.
