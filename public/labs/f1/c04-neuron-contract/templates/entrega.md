# Entrega del kit: Kit F1 C04: neurona artificial con contrato de dimensiones

## 0. Archivos del ZIP que he usado

- Entradas: `data/neuron_cases.json`.
- Contratos o políticas: `contracts/neuron_policy.json`.
- Código ejecutado: `ops/run_neuron_contract.py`.
- Evidencias generadas: `output/neuron_decision.md` y `output/neuron_report.json`.
