# Entrega del kit: Kit F1 C08: elegir arquitectura antes de entrenar

## 0. Archivos del ZIP que he usado

- Entradas: `data/problem_cases.json`.
- Contratos o políticas: `contracts/architecture_policy.json`.
- Código ejecutado: `ops/audit_architecture_triage.py`.
- Evidencias generadas: `output/architecture_triage_decision.md` y `output/architecture_triage_report.json`.
