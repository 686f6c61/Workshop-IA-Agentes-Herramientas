# Entrega del kit: Kit F1 C03: elegir el principio de IA adecuado

## 0. Archivos del ZIP que he usado

- Entradas: `data/project_cases.json`.
- Contratos o políticas: `contracts/principle_policy.json`.
- Código ejecutado: `ops/route_ai_principles.py`.
- Evidencias generadas: `output/principle_decision.md` y `output/principle_report.json`.
