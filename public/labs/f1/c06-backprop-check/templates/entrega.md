# Entrega del kit: Kit F1 C06: comprobar retropropagación

## 0. Archivos del ZIP que he usado

- Entradas: `data/backprop_cases.json`.
- Contratos o políticas: `contracts/backprop_policy.json`.
- Código ejecutado: `ops/check_backprop.py`.
- Evidencias generadas: `output/backprop_decision.md` y `output/backprop_report.json`.
