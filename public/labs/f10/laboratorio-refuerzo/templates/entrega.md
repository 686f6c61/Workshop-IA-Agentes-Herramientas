# Entrega del kit: F10 · Laboratorio de refuerzo

## 0. Archivos del ZIP que he usado

- Entradas: `data/bandit_rewards.json` y `data/reward_cases.json`.
- Contratos o políticas: `contracts/refuerzo_lab_contract.json`.
- Código ejecutado: `ops/audit_reward_spec.py`, `ops/check_student_submission.py` y `ops/simulate_bandit_policy.py`.
- Evidencias generadas: `output/bandit_policy_decision.md`, `output/ope_decision.md`, `output/ope_quality_card.md`, `output/reward_card.md`, `output/serving_decision.md` y `output/serving_runbook.md`.
