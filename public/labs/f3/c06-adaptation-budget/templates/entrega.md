# Entrega del kit: Kit F3 C06: presupuesto de adaptación y destilación

## 0. Archivos del ZIP que he usado

- Entradas: `data/adaptation_case.json`.
- Contratos o políticas: `contracts/adaptation_policy.json`.
- Código ejecutado: `ops/estimate_adaptation_budget.py`.
- Evidencias generadas: `output/adaptation_budget_decision.md` y `output/adaptation_budget_report.json`.
