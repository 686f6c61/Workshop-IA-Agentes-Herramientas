# Entrega del kit: Kit F3 C05: sondas de arquitecturas modernas

## 0. Archivos del ZIP que he usado

- Entradas: `data/modern_architecture_case.json`.
- Contratos o políticas: `contracts/modern_architecture_policy.json`.
- Código ejecutado: `ops/probe_modern_architectures.py`.
- Evidencias generadas: `output/modern_architecture_decision.md` y `output/modern_architecture_report.json`.
