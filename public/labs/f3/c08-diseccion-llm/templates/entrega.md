# Entrega del kit: Kit F3 C08: diseccion de una llamada a un LLM

## 0. Archivos del ZIP que he usado

- Entradas: `data/request_case.json` y `data/toy_vocab.json`.
- Contratos o políticas: `contracts/dissection_policy.json`.
- Código ejecutado: `ops/dissect_llm_request.py`.
- Evidencias generadas: `output/dissection_report.md` y `output/dissection_report.json`.
