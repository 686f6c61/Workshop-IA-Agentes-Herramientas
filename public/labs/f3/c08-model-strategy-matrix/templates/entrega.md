# Entrega del kit: Kit F3 C08: matriz de estrategia de modelo

## 0. Archivos del ZIP que he usado

- Entradas: `data/model_strategy_case.json`.
- Contratos o políticas: `contracts/model_strategy_policy.json`.
- Código ejecutado: `ops/score_model_strategy.py`.
- Evidencias generadas: `output/model_strategy_decision.md` y `output/model_strategy_report.json`.
