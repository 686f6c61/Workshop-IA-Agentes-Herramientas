# Entrega del kit: Kit F3 C04: LayerNorm y controles de sampling

## 0. Archivos del ZIP que he usado

- Entradas: `data/sampling_case.json`.
- Contratos o políticas: `contracts/sampling_policy.json`.
- Código ejecutado: `ops/run_sampling_controls.py`.
- Evidencias generadas: `output/sampling_controls_decision.md` y `output/sampling_controls_report.json`.
