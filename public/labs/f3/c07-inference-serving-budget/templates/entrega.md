# Entrega del kit: Kit F3 C07: presupuesto de inferencia y serving

## 0. Archivos del ZIP que he usado

- Entradas: `data/serving_scenario.json`.
- Contratos o políticas: `contracts/serving_policy.json`.
- Código ejecutado: `ops/estimate_serving_budget.py`.
- Evidencias generadas: `output/serving_budget_decision.md` y `output/serving_budget_report.json`.
