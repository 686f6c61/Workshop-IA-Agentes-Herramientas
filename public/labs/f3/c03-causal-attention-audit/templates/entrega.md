# Entrega del kit: Kit F3 C03: auditoría QKV y máscara causal

## 0. Archivos del ZIP que he usado

- Entradas: `data/qkv_case.json`.
- Contratos o políticas: `contracts/causal_attention_policy.json`.
- Código ejecutado: `ops/audit_causal_attention.py`.
- Evidencias generadas: `output/causal_attention_decision.md` y `output/causal_attention_report.json`.
