# Entrega del kit: Kit F3 C01: pérdida y memoria de un LLM

## 0. Archivos del ZIP que he usado

- Entradas: `data/loss_memory_case.json`.
- Contratos o políticas: `contracts/loss_memory_policy.json`.
- Código ejecutado: `ops/estimate_loss_memory.py`.
- Evidencias generadas: `output/loss_memory_decision.md` y `output/loss_memory_report.json`.
