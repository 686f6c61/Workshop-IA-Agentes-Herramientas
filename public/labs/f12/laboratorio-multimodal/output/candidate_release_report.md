# Informe de release multimodal · candidate

Decisión global: `ship`
Casos: `8` · pass `8` · review `0` · block `0`
Calidad media: `0.84` · riesgo medio: `0.0762`
...
| `parking_video_event_triage` | 0.815 | 0.06 | 2050 ms | `pass` | none | Publicar con monitorización y conservar evidencia de release. |
